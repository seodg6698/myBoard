...
public class BoardServiceImpl implements BoardService{
	...
	@Override
	public List<BoardDto> searchTitleBoardList(String keyword) throws Exception {
		System.out.println(keyword +" ::service");
		List<BoardDto> boardList = boardMapper.searchTitleBoardList(keyword);
		System.out.println(boardList +" ::service");
		return boardList;
	}

	@Override
	public List<BoardDto> searchContentsBoardList(String keyword) {
		List<BoardDto> boardList = boardMapper.searchContentsBoardList(keyword);
		System.out.println(keyword +" ::service");
		System.out.println(boardList +" ::service");
		return boardList;
	}
